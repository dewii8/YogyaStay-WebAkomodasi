                    ...
                    <div class="filter-row">
                        ...
                        <div class="filter-group">
                            ...
                            <select name="tanggal" class="filter-select">
                                <option value="semua" <?= $filter_tanggal == 'semua' ? 'selected' : '' ?>>Semua Waktu
                                </option>
                                <option value="hari_ini" <?= $filter_tanggal == 'hari_ini' ? 'selected' : '' ?>>Hari Ini
                                </option>
                                <option value="minggu_ini" <?= $filter_tanggal == 'minggu_ini' ? 'selected' : '' ?>>Minggu
                                    Ini</option>
                                <option value="bulan_ini" <?= $filter_tanggal == 'bulan_ini' ? 'selected' : '' ?>>Bulan Ini
                                </option>
                            </select>
                        </div>
