<?php
// Path ke config.php dari folder admin/pembatalanKamar/
...
// Fungsi untuk logging aktivitas admin - DIPERBAIKI
...
// Handle aksi refund/tolak - DIPERBAIKI TOTAL + INTEGRASI TABEL REFUND
if(isset($_POST['action']) && isset($_POST['id_pembatalan'])) {
    ...
    if($action == 'approve') {
        ...
        try {
            ...
            // 3. ✅ INSERT KE TABEL REFUND - FITUR BARU
            ...
            if(!$check_admin || mysqli_num_rows($check_admin) == 0) {
                ...
                // Jangan insert log jika admin tidak valid, tapi tetap lanjut transaksi
            } else {
...
.content{margin-left:240px;padding:30px;width:100%;max-width:1600px}
...
.toggle-btn{display:none;font-size:26px;background:none;border:none;cursor:pointer}
                    ...
                    <?php if($query_pembatalan && mysqli_num_rows($query_pembatalan) > 0): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <small style="color:#9ca3af"><?= htmlspecialchars($row['email_pelanggan']) ?></small>
                            </td>
...
<div id="rejectModal" class="modal">
    <div class="modal-content">
        ...
        <form method="POST" id="rejectForm" onsubmit="return submitReject(event)">
            ...
            <textarea name="alasan_admin" id="alasan_admin" placeholder="Masukkan alasan penolakan (minimal 10 karakter)..." required></textarea>
