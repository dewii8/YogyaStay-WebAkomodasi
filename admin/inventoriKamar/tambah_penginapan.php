...
<body>
    ...
    <div class="modal">
        ...
        <div class="alert alert-warning">
            <strong>📌 Petunjuk:</strong> Pastikan semua field bertanda * (wajib) sudah diisi. Upload minimal 1 gambar
            penginapan.
        </div>
        ...
        <form method="POST" enctype="multipart/form-data" id="formPenginapan">
            ...
            <div class="form-grid">
                ...
                <div class="form-group form-full">
                    ...
                    <textarea name="deskripsi" placeholder="Jelaskan keunggulan dan daya tarik penginapan Anda..."
                        required></textarea>
                </div>
                ...
                <div class="form-group form-full">
                    ...
                    <textarea name="tentang_kami"
                        placeholder="Ceritakan lebih banyak tentang penginapan Anda..."></textarea>
                </div>
