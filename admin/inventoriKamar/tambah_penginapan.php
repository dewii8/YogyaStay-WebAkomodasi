...
<title>Tambah Penginapan - DEBUG MODE</title>
...
<form method="POST" enctype="multipart/form-data" id="formPenginapan" onsubmit="console.log('Form submitted!'); return true;">
