        ...
        <div class="hero-container">
            <div class="hero-header">
                ...
                <div class="hero-location">
                    ...
                    <span><?= htmlspecialchars($penginapan['nama_kecamatan']) ?>,
                        <?= htmlspecialchars($penginapan['nama_kabupaten']) ?></span>
                </div>
            </div>
            ...
            <div class="gallery-grid">
                ...
                <div class="gallery-main">
                    <img src="../../<?= htmlspecialchars($gambar_array[0]) ?>"
                        alt="<?= htmlspecialchars($penginapan['nama_penginapan']) ?>"
                ...
                <div class="gallery-sidebar">
                    <?php for ($i = 1; $i <= 2; $i++) {
                        ...
                        <div class="gallery-item">
                            <img src="../../<?= htmlspecialchars($img_src) ?>" alt="Gallery <?= $i ?>"
                                onerror="this.src='../../uploads/penginapan/default.jpg'">
                        </div>
                    <?php } ?>
                </div>
    ...
    <div class="detail-container">
        <div class="detail-main">
            ...
            <div id="tipe-kamar" class="section-card">
                <h2 class="section-title">Tipe
                    Kamar<?php if ($result_kamar && mysqli_num_rows($result_kamar) > 0) {
                        echo ' (' . mysqli_num_rows($result_kamar) . ' Tipe)';
                    } ?>
                </h2>
                <div class="room-grid">
                    <?php
                                ...
                                <div class="room-info">
                                    ...
                                    <div class="room-price-box">
                                        <div>
                                            ...
                                            <div class="room-price">Rp
                                                <?= number_format($kamar['harga_per_malam'], 0, ',', '.') ?></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="location-content">
                    ...
                    <div class="address-box">
                        ...
                        <div class="address-text">
                            <strong><?= htmlspecialchars($penginapan['nama_kecamatan']) ?>,
                                <?= htmlspecialchars($penginapan['nama_kabupaten']) ?></strong><br>
