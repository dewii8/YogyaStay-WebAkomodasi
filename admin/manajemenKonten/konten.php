...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])) {
    ...
    if (isset($_FILES['thumbnail']) && $_FILES['thumbnail']['error'] == 0) {
        ...
        if (move_uploaded_file($_FILES["thumbnail"]["tmp_name"], $target_file)) {
            ...
            if ($result) {
                // LOGGING AKTIVITAS ADMIN - DIPERBAIKI DENGAN AUTO-DETECT KOLOM
                        ...
                        <td>
                            <div class="action-buttons">
                                ...
                                <a href="javascript:void(0)" 
                                   class="btn-action btn-delete btn-delete-blog" 
                                   data-id="<?= $row['id_blog']; ?>"
...
<div class="modal-overlay" id="deleteModal">
    <div class="modal-box">
        ...
        <p id="deleteMessage">Data postingan, termasuk gambar, akan dihapus permanen. Tindakan ini tidak dapat dibatalkan.</p>
