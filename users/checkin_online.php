...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['verifikasi'])) {
    ...
    $sql = "SELECT 
            ...
            AND b.status_reservasi = 'confirmed'";
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        $error_message = "Data booking tidak ditemukan atau sudah check-in. Pastikan ID Booking dan Email sudah benar.";
    }
}
        ...
        <div class="checkin-card">
            ...
            <?php if ($step == 1): ?>
                ...
                <form method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" name="kode_booking" class="form-input" 
                               placeholder="Contoh: JS-123456" required>
                    </div>
            ...
            <?php elseif ($step == 2 && isset($_SESSION['checkin_booking'])): ?>
                ...
                <div class="booking-data-box">
                    ...
                    <div class="booking-data-item"><strong>Nama Pemesan:</strong> <?= htmlspecialchars($booking['nama']) ?></div>
                    <div class="booking-data-item"><strong>Tanggal Pemesanan:</strong> <?= $checkin_date ?></div>
                    <div class="booking-data-item"><strong>Lokasi:</strong> <?= htmlspecialchars($booking['nama_penginapan']) ?></div>
                    <div class="booking-data-item"><strong>Tipe Kamar:</strong> <?= htmlspecialchars($booking['nama_tipe'] ?? 'Standard Room') ?></div>
                </div>
                ...
                <form method="POST" enctype="multipart/form-data">
                    <div class="upload-section">
                        ...
                        <div class="file-input-wrapper">
                            <input type="file" name="foto_ktp" id="foto_ktp" class="file-input" 
                            ...
                            <div class="file-note">Unggah scan KTP/Passport Anda (jpg, jpeg, png)</div>
                        </div>
                    </div>
...
document.getElementById('foto_ktp')?.addEventListener('change', function(e) {
    ...
    if (e.target.files[0]) {
        ...
        document.getElementById('file-label-text').textContent = 'Pilih File';
    }
});
</script>
